...
enum AppThemeControlStrings {
    static func text(_ key: String, language: String) -> String {
        let localized: [String: [String: String]] = [
            "zh": [
                "title": "应用主题控制",
                "description": "为不支持深浅色外观的 App 设置显示主题。可跟随系统、固定深色或浅色，也可按时间自动切换。",
                ...
                "permissionDetail": "用于在本机转换你选定 App 的主题；不会录制或上传。若刚在系统设置中授权，请完全退出后重新打开暗光，再点“重新检查”。",
                "continueAllow": "继续并授权",
                "checkAgain": "重新检查",
                "openSettings": "打开系统设置",
                "schedule": "按时间切换",
            ...
            "ja": [
                "title": "アプリテーマ管理",
                "description": "ダーク／ライト表示に対応していないアプリの表示テーマを設定します。システムに従う、常にダーク／ライトにする、時間で自動的に切り替えることができます。",
                ...
                "permissionDetail": "選択したアプリのテーマをこの Mac 上で変換するために使用します。画面内容の録画・保存・送信は行いません。システム設定で許可した直後は、Dark Light を完全に終了して開き直し、「再確認」を押してください。",
                "continueAllow": "続けて許可",
                "checkAgain": "再確認",
            ...
            "ko": [
                "title": "앱 테마 제어",
                "description": "기본 밝은색 및 어두운색 모양을 지원하지 않는 앱의 표시 테마를 설정합니다. 시스템을 따르거나, 항상 어둡게 또는 밝게 표시하거나, 시간에 따라 자동으로 전환할 수 있습니다.",
                ...
                "permissionDetail": "선택한 앱의 테마를 이 Mac에서 변환하는 데 사용합니다. 화면 내용은 기록, 저장 또는 전송하지 않습니다. 시스템 설정에서 권한을 막 허용했다면 Dark Light를 완전히 종료한 뒤 다시 열고 ‘다시 확인’을 누르세요.",
            ...
            "es": [
                ...
                "description": "Define un tema de visualización para apps que no tienen aspecto claro y oscuro integrado. Sigue el sistema, mantenlas claras u oscuras, o cambia automáticamente por horario.",
                ...
                "permissionDetail": "Se utiliza para transformar localmente el tema de las apps seleccionadas. No se graba, guarda ni envía el contenido de la pantalla. Si acabas de autorizarlo en Ajustes del Sistema, cierra Dark Light por completo, ábrelo de nuevo y pulsa «Comprobar de nuevo».",
            ...
            "fr": [
                ...
                "description": "Définissez un thème d’affichage pour les apps qui ne proposent pas d’apparence claire et sombre. Suivez le système, gardez-les claires ou sombres, ou changez automatiquement selon l’heure.",
                ...
                "permissionDetail": "Il sert à transformer localement le thème des apps sélectionnées. Le contenu de l’écran n’est ni enregistré, ni conservé, ni envoyé. Si vous venez de l’autoriser dans Réglages Système, quittez entièrement Dark Light, relancez-le, puis cliquez sur « Vérifier à nouveau ».",
            ...
            "de": [
                ...
                "description": "Legen Sie ein Darstellungsthema für Apps ohne integriertes helles und dunkles Erscheinungsbild fest. Folgen Sie dem System, halten Sie Apps hell oder dunkel oder wechseln Sie automatisch nach Zeitplan.",
            ...
            "en": [
                ...
                "description": "Set a display theme for apps without built-in light and dark appearance support. Follow the system, keep an app dark or light, or switch automatically by time.",
                ...
                "permissionDetail": "This lets Dark Light transform selected app themes locally. Nothing is recorded, saved, or uploaded. If you just enabled it in System Settings, fully quit and reopen Dark Light, then click Check again.",
